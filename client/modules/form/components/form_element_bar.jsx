      ...
      <div role="navigation">
        <div className="panel panel-default">
          ...
          <div role="presentation" className="list-group-item field-list-entry">
              <a href="#" onClick={this._addElementToPlayground.bind(this, 'object') }>
                <i className="fa fa-plus-square" aria-hidden="true"></i> Object
              </a>
            </div>

            <div role="presentation" className="list-group-item field-list-entry">
              <a href="#" onClick={this._addElementToPlayground.bind(this, 'array') }>
